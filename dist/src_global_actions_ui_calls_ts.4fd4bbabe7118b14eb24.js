...
/* harmony import */ var _util_messageKey__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../util/messageKey */ "./src/util/messageKey.ts");
...
const SERVICE_NOTIFICATIONS_USER_MOCK = {
  id: _config__WEBPACK_IMPORTED_MODULE_2__.SERVICE_NOTIFICATIONS_USER_ID,
  accessHash: '0',
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('preloadTopChatMessages', async (global, actions) => {
  ...
  for (let i = 0; i < _config__WEBPACK_IMPORTED_MODULE_2__.TOP_CHAT_MESSAGES_PRELOAD_LIMIT; i++) {
    ...
    .map(_ref => {
      ...
      return (0,_selectors__WEBPACK_IMPORTED_MODULE_19__.selectCurrentMessageList)(global, tabId)?.chatId;
    }).filter(Boolean);
...
function abortChatRequestsForCurrentChat(global, newChatId, newThreadId) {
  for (var _len = arguments.length, _ref2 = new Array(_len > 3 ? _len - 3 : 0), _key = 3; _key < _len; _key++) {
    _ref2[_key - 3] = arguments[_key];
  }
  let [tabId = (0,_util_establishMultitabRole__WEBPACK_IMPORTED_MODULE_6__.getCurrentTabId)()] = _ref2;
  ...
  if (currentChatId && (currentChatId !== newChatId || currentThreadId !== newThreadId)) {
    const [isChatOpened, isThreadOpened] = Object.values(global.byTabId).reduce((_ref3, _ref4) => {
      let [accHasChatOpened, accHasThreadOpened] = _ref3;
      let {
        id: otherTabId
      } = _ref4;
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('openThread', async (global, actions, payload) => {
  ...
  global = (0,_reducers__WEBPACK_IMPORTED_MODULE_16__.addChats)(global, (0,_util_iteratees__WEBPACK_IMPORTED_MODULE_8__.buildCollectionByKey)(result.chats, 'id'));
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('loadAllChats', async (global, actions, payload) => {
  ...
  let i = 0;
  const getOrderDate = chat => {
    return (0,_selectors__WEBPACK_IMPORTED_MODULE_19__.selectChatLastMessage)(global, chat.id, listType === 'saved' ? 'saved' : 'all')?.date || chat.creationDate;
  };
  while (shouldReplace || !global.chats.isFullyLoaded[listType]) {
    ...
    const oldestChat = listIds ? listIds
    /* eslint-disable @typescript-eslint/no-loop-func */.map(id => global.chats.byId[id]).filter(chat => Boolean(chat && getOrderDate(chat)) && chat.id !== _config__WEBPACK_IMPORTED_MODULE_2__.SERVICE_NOTIFICATIONS_USER_ID && !(0,_selectors__WEBPACK_IMPORTED_MODULE_19__.selectIsChatPinned)(global, chat.id))
    /* eslint-enable @typescript-eslint/no-loop-func */.sort((chat1, chat2) => getOrderDate(chat1) - getOrderDate(chat2))[0] : undefined;
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('requestSavedDialogUpdate', async (global, actions, payload) => {
  ...
  if (result.messages.length) {
    ...
    global = (0,_reducers__WEBPACK_IMPORTED_MODULE_16__.updateChatListIds)(global, 'saved', [chatId]);
    (0,_index__WEBPACK_IMPORTED_MODULE_15__.setGlobal)(global);
  } else {
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('leaveChannel', async (global, actions, payload) => {
  ...
  if (channelId && accessHash) {
    ...
    const localMessageIds = Object.keys(chatMessages).map(Number).filter(_util_messageKey__WEBPACK_IMPORTED_MODULE_9__.isLocalMessageId);
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('addChatFolder', async (global, actions, payload) => {
  ...
  if (recommended) {
    global = {
      ...
      chatFolders: {
        ...global.chatFolders,
        recommended: recommended.filter(_ref6 => {
          let {
            id
          } = _ref6;
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('openChatByInvite', async (global, actions, payload) => {
  const {
    hash,
    tabId = (0,_util_establishMultitabRole__WEBPACK_IMPORTED_MODULE_6__.getCurrentTabId)()
  } = payload;
  const result = await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_13__.callApi)('openChatByInvite', hash);
  if (!result) {
    return;
  }
  actions.openChat({
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('openTelegramLink', (global, actions, payload) => {
  const {
    url,
    tabId = (0,_util_establishMultitabRole__WEBPACK_IMPORTED_MODULE_6__.getCurrentTabId)()
  } = payload;
  ...
  const choose = (0,_util_deeplink__WEBPACK_IMPORTED_MODULE_4__.parseChooseParameter)(params.choose);
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('acceptInviteConfirmation', async (global, actions, payload) => {
  const {
    hash,
    tabId = (0,_util_establishMultitabRole__WEBPACK_IMPORTED_MODULE_6__.getCurrentTabId)()
  } = payload;
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('openChatByUsername', async (global, actions, payload) => {
  ...
  if (!commentId) {
    if (startAttach === undefined && messageId && !startParam && chat?.usernames?.some(c => c.username === username)) {
      actions.focusMessage({
        chatId: chat.id,
        threadId,
        messageId,
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('updateChatPhoto', async (global, actions, payload) => {
  ...
  await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_13__.callApi)('deleteProfilePhotos', [photo]);
  actions.loadFullChat({
    chatId,
    tabId,
    withPhotos: true
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('deleteChatPhoto', async (global, actions, payload) => {
  ...
  const result = await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_13__.callApi)('deleteProfilePhotos', photosToDelete);
  if (!result) return;
  actions.loadFullChat({
    chatId,
    tabId,
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('loadGroupsForDiscussion', async global => {
  ...
  global = (0,_index__WEBPACK_IMPORTED_MODULE_15__.getGlobal)();
  global = (0,_reducers__WEBPACK_IMPORTED_MODULE_16__.addChats)(global, addedById);
  global = {
    ...global,
    chats: {
      ...global.chats,
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('loadMoreMembers', async (global, actions, payload) => {
  ...
  global = (0,_index__WEBPACK_IMPORTED_MODULE_15__.getGlobal)();
  global = (0,_reducers__WEBPACK_IMPORTED_MODULE_16__.addUsers)(global, (0,_util_iteratees__WEBPACK_IMPORTED_MODULE_8__.buildCollectionByKey)(users, 'id'));
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('loadTopics', async (global, actions, payload) => {
  ...
  } = offsetTopic && chat.topics?.[offsetTopic] || {};
  ...
  Object.entries(result.draftsById || {}).forEach(_ref7 => {
    let [threadId, draft] = _ref7;
    global = (0,_reducers__WEBPACK_IMPORTED_MODULE_16__.replaceThreadParam)(global, chatId, Number(threadId), 'draft', draft);
  });
  Object.entries(result.readInboxMessageIdByTopicId || {}).forEach(_ref8 => {
    let [topicId, messageId] = _ref8;
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('loadChannelRecommendations', async (global, actions, payload) => {
  ...
  global = (0,_index__WEBPACK_IMPORTED_MODULE_15__.getGlobal)();
  global = (0,_reducers__WEBPACK_IMPORTED_MODULE_16__.addChats)(global, chatsById);
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('resolveBusinessChatLink', async (global, actions, payload) => {
  ...
  global = (0,_index__WEBPACK_IMPORTED_MODULE_15__.getGlobal)();
  global = (0,_reducers__WEBPACK_IMPORTED_MODULE_16__.addUsers)(global, (0,_util_iteratees__WEBPACK_IMPORTED_MODULE_8__.buildCollectionByKey)(users, 'id'));
  global = (0,_reducers__WEBPACK_IMPORTED_MODULE_16__.addChats)(global, (0,_util_iteratees__WEBPACK_IMPORTED_MODULE_8__.buildCollectionByKey)(chats, 'id'));
  (0,_index__WEBPACK_IMPORTED_MODULE_15__.setGlobal)(global);
  actions.openChatWithDraft({
...
async function loadChats(listType, offsetId, offsetDate) {
  let shouldReplace = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  let isFullDraftSync = arguments.length > 4 ? arguments[4] : undefined;
  // eslint-disable-next-line eslint-multitab-tt/no-immediate-global
  ...
  if (shouldReplace) {
    if (listType === 'active') {
      ...
      if (!chatIds.includes(_config__WEBPACK_IMPORTED_MODULE_2__.SERVICE_NOTIFICATIONS_USER_ID)) {
        const result2 = await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_13__.callApi)('fetchChat', {
          type: 'user',
          user: SERVICE_NOTIFICATIONS_USER_MOCK
        });
        global = (0,_index__WEBPACK_IMPORTED_MODULE_15__.getGlobal)();
        const notificationsChat = result2 && (0,_selectors__WEBPACK_IMPORTED_MODULE_19__.selectChat)(global, result2.chatId);
      ...
      const topArchivedChats = (0,_util_folderManager__WEBPACK_IMPORTED_MODULE_7__.getOrderedIds)(_config__WEBPACK_IMPORTED_MODULE_2__.ARCHIVED_FOLDER_ID)?.slice(0, _config__WEBPACK_IMPORTED_MODULE_2__.GLOBAL_STATE_CACHE_ARCHIVED_CHAT_LIST_LIMIT).map(chatId => (0,_selectors__WEBPACK_IMPORTED_MODULE_19__.selectChat)(global, chatId)).filter(Boolean);
      const visibleChats = tabStates.flatMap(_ref9 => {
        let {
          id: tabId
        } = _ref9;
      ...
      const visibleUsers = tabStates.flatMap(_ref10 => {
        let {
          id: tabId
        } = _ref10;
        return (0,_selectors__WEBPACK_IMPORTED_MODULE_19__.selectVisibleUsers)(global, tabId) || [];
      });
      if (global.currentUserId && global.users.byId[global.currentUserId]) {
        visibleUsers.push(global.users.byId[global.currentUserId]);
      }
      global = (0,_reducers__WEBPACK_IMPORTED_MODULE_16__.replaceUsers)(global, (0,_util_iteratees__WEBPACK_IMPORTED_MODULE_8__.buildCollectionByKey)(visibleUsers.concat(result.users), 'id'));
      global = (0,_reducers__WEBPACK_IMPORTED_MODULE_16__.replaceUserStatuses)(global, result.userStatusesById);
      global = (0,_reducers__WEBPACK_IMPORTED_MODULE_16__.replaceChats)(global, (0,_util_iteratees__WEBPACK_IMPORTED_MODULE_8__.buildCollectionByKey)(chatsToSave.concat(result.chats), 'id'));
      ...
      global = (0,_reducers__WEBPACK_IMPORTED_MODULE_16__.updateChats)(global, (0,_util_iteratees__WEBPACK_IMPORTED_MODULE_8__.buildCollectionByKey)(result.chats, 'id'));
      global = (0,_reducers__WEBPACK_IMPORTED_MODULE_16__.replaceChatListIds)(global, listType, chatIds);
    }
  } else {
    ...
    global = (0,_reducers__WEBPACK_IMPORTED_MODULE_16__.updateChatListIds)(global, listType, chatIds);
  }
...
async function loadFullChat(global, actions, chat) {
  for (var _len2 = arguments.length, _ref11 = new Array(_len2 > 3 ? _len2 - 3 : 0), _key2 = 3; _key2 < _len2; _key2++) {
    _ref11[_key2 - 3] = arguments[_key2];
  }
  let [tabId = (0,_util_establishMultitabRole__WEBPACK_IMPORTED_MODULE_6__.getCurrentTabId)()] = _ref11;
...
async function migrateChat(global, actions, chat) {
  for (var _len3 = arguments.length, _ref12 = new Array(_len3 > 3 ? _len3 - 3 : 0), _key3 = 3; _key3 < _len3; _key3++) {
    _ref12[_key3 - 3] = arguments[_key3];
  }
  let [tabId = (0,_util_establishMultitabRole__WEBPACK_IMPORTED_MODULE_6__.getCurrentTabId)()] = _ref12;
  try {
...
async function fetchChatByUsername(global, username) {
  global = (0,_index__WEBPACK_IMPORTED_MODULE_15__.getGlobal)();
  const localChat = (0,_selectors__WEBPACK_IMPORTED_MODULE_19__.selectChatByUsername)(global, username);
  ...
  const {
    chat,
    user
  } = (await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_13__.callApi)('getChatByUsername', username)) || {};
  if (!chat) {
    return undefined;
  }
  global = (0,_index__WEBPACK_IMPORTED_MODULE_15__.getGlobal)();
...
async function getAttachBotOrNotify(global, actions, username) {
  for (var _len4 = arguments.length, _ref13 = new Array(_len4 > 3 ? _len4 - 3 : 0), _key4 = 3; _key4 < _len4; _key4++) {
    _ref13[_key4 - 3] = arguments[_key4];
  }
  let [tabId = (0,_util_establishMultitabRole__WEBPACK_IMPORTED_MODULE_6__.getCurrentTabId)()] = _ref13;
...
async function openChatByUsername(global, actions, params) {
  for (var _len5 = arguments.length, _ref14 = new Array(_len5 > 3 ? _len5 - 3 : 0), _key5 = 3; _key5 < _len5; _key5++) {
    _ref14[_key5 - 3] = arguments[_key5];
  }
  let [tabId = (0,_util_establishMultitabRole__WEBPACK_IMPORTED_MODULE_6__.getCurrentTabId)()] = _ref14;
  const {
    username,
    threadId,
    channelPostId,
...
async function openAttachMenuFromLink(global, actions, chatId, attach, startAttach) {
  for (var _len6 = arguments.length, _ref15 = new Array(_len6 > 5 ? _len6 - 5 : 0), _key6 = 5; _key6 < _len6; _key6++) {
    _ref15[_key6 - 5] = arguments[_key6];
  }
  let [tabId = (0,_util_establishMultitabRole__WEBPACK_IMPORTED_MODULE_6__.getCurrentTabId)()] = _ref15;
  global = (0,_index__WEBPACK_IMPORTED_MODULE_15__.getGlobal)();
...
async function ensureIsSuperGroup(global, actions, chatId) {
  for (var _len7 = arguments.length, _ref16 = new Array(_len7 > 3 ? _len7 - 3 : 0), _key7 = 3; _key7 < _len7; _key7++) {
    _ref16[_key7 - 3] = arguments[_key7];
  }
  let [tabId = (0,_util_establishMultitabRole__WEBPACK_IMPORTED_MODULE_6__.getCurrentTabId)()] = _ref16;
  const chat = (0,_selectors__WEBPACK_IMPORTED_MODULE_19__.selectChat)(global, chatId);
  if (!chat || !(0,_helpers__WEBPACK_IMPORTED_MODULE_14__.isChatBasicGroup)(chat)) {
    return chat;
  }
...
/* harmony import */ var _reducers_calls__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../reducers/calls */ "./src/global/reducers/calls.ts");
...
/* harmony import */ var _selectors_calls__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../selectors/calls */ "./src/global/selectors/calls.ts");
/* harmony import */ var _api_chats__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../api/chats */ "./src/global/actions/api/chats.ts");
...
async function fetchGroupCall(global, groupCall) {
  ...
  const existingGroupCall = (0,_selectors_calls__WEBPACK_IMPORTED_MODULE_14__.selectGroupCall)(global, groupCall.id);
  global = (0,_reducers_calls__WEBPACK_IMPORTED_MODULE_11__.updateGroupCall)(global, groupCall.id, (0,_util_iteratees__WEBPACK_IMPORTED_MODULE_3__.omit)(result.groupCall, ['connectionState']), undefined, existingGroupCall?.isLoaded ? undefined : result.groupCall.participantsCount);
...
async function fetchGroupCallParticipants(global, groupCall, nextOffset) {
  const result = await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_7__.callApi)('fetchGroupCallParticipants', {
    call: groupCall,
    offset: nextOffset
  });
  if (!result) return;
...
(0,_index__WEBPACK_IMPORTED_MODULE_9__.addActionHandler)('toggleGroupCallPanel', (global, actions, payload) => {
  ...
  return (0,_reducers_tabs__WEBPACK_IMPORTED_MODULE_12__.updateTabState)(global, {
    isCallPanelVisible: 'force' in (payload || {}) ? force : !(0,_selectors__WEBPACK_IMPORTED_MODULE_13__.selectTabState)(global, tabId).isCallPanelVisible
  }, tabId);
});
(0,_index__WEBPACK_IMPORTED_MODULE_9__.addActionHandler)('subscribeToGroupCallUpdates', async (global, actions, payload) => {
  ...
  const groupCall = (0,_selectors_calls__WEBPACK_IMPORTED_MODULE_14__.selectGroupCall)(global, id);
  if (!groupCall) return;
  if (subscribed) {
...
(0,_index__WEBPACK_IMPORTED_MODULE_9__.addActionHandler)('createGroupCall', async (global, actions, payload) => {
  ...
  if (!result) return;
  global = (0,_index__WEBPACK_IMPORTED_MODULE_9__.getGlobal)();
  global = (0,_reducers_calls__WEBPACK_IMPORTED_MODULE_11__.updateGroupCall)(global, result.id, {
    ...result,
    chatId
  });
  (0,_index__WEBPACK_IMPORTED_MODULE_9__.setGlobal)(global);
...
(0,_index__WEBPACK_IMPORTED_MODULE_9__.addActionHandler)('createGroupCallInviteLink', async (global, actions, payload) => {
  ...
  const groupCall = (0,_selectors_calls__WEBPACK_IMPORTED_MODULE_14__.selectActiveGroupCall)(global);
  if (!groupCall || !groupCall.chatId) {
    return;
  }
  const chat = (0,_selectors__WEBPACK_IMPORTED_MODULE_13__.selectChat)(global, groupCall.chatId);
  if (!chat) {
    return;
  }
  const hasPublicUsername = Boolean((0,_helpers__WEBPACK_IMPORTED_MODULE_8__.getMainUsername)(chat));
  let inviteLink = (0,_selectors__WEBPACK_IMPORTED_MODULE_13__.selectChatFullInfo)(global, chat.id)?.inviteLink;
...
(0,_index__WEBPACK_IMPORTED_MODULE_9__.addActionHandler)('joinVoiceChatByLink', async (global, actions, payload) => {
  ...
  const chat = await (0,_api_chats__WEBPACK_IMPORTED_MODULE_15__.fetchChatByUsername)(global, username);
  if (!chat) {
    actions.showNotification({
  ...
  global = (0,_index__WEBPACK_IMPORTED_MODULE_9__.getGlobal)();
  const full = await (0,_api_chats__WEBPACK_IMPORTED_MODULE_15__.loadFullChat)(global, actions, chat, tabId);
  if (full?.groupCall) {
    actions.requestMasterAndJoinGroupCall({
...
(0,_index__WEBPACK_IMPORTED_MODULE_9__.addActionHandler)('joinGroupCall', async (global, actions, payload) => {
  ...
  let groupCall = id ? (0,_selectors_calls__WEBPACK_IMPORTED_MODULE_14__.selectGroupCall)(global, id) : (0,_selectors_calls__WEBPACK_IMPORTED_MODULE_14__.selectChatGroupCall)(global, chatId);
  ...
  if (!groupCall && (!id || !accessHash) && chatId) {
    const chat = (0,_selectors__WEBPACK_IMPORTED_MODULE_13__.selectChat)(global, chatId);
    if (!chat) return;
    await (0,_api_chats__WEBPACK_IMPORTED_MODULE_15__.loadFullChat)(global, actions, chat, tabId);
    global = (0,_index__WEBPACK_IMPORTED_MODULE_9__.getGlobal)();
    groupCall = (0,_selectors_calls__WEBPACK_IMPORTED_MODULE_14__.selectChatGroupCall)(global, chatId);
  ...
  if (!groupCall) return;
  global = (0,_index__WEBPACK_IMPORTED_MODULE_9__.getGlobal)();
  global = (0,_reducers_calls__WEBPACK_IMPORTED_MODULE_11__.updateGroupCall)(global, groupCall.id, {
    ...groupCall,
    inviteHash
...
function checkNavigatorUserMediaPermissions(global, actions, isVideo) {
...
function checkMicrophonePermission(global, actions) {
...
function updateGroupCall(global, groupCallId, groupCallUpdate, addToParticipantCount, resetParticipantCount) {
  ...
  const filtered = unfiltered.filter(_ref => {
    let {
      isLeft
    } = _ref;
    return !isLeft;
...
function updateGroupCallParticipant(global, groupCallId, userId, participantUpdate) {
  let noUpdateCount = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
  const groupCall = (0,_selectors_calls__WEBPACK_IMPORTED_MODULE_2__.selectGroupCall)(global, groupCallId);
  if (!groupCall) {
    return global;
  }
...
//# sourceMappingURL=src_global_actions_ui_calls_ts.4fd4bbabe7118b14eb24.js.map