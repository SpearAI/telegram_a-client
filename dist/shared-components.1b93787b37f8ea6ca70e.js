...
/* harmony export */ });
/* harmony import */ var _lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../lib/teact/teact */ "./src/lib/teact/teact.ts");
/* harmony import */ var _Checkbox__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Checkbox */ "./src/components/ui/Checkbox.tsx");
...
const CheckboxGroup = _ref => {
  ...
  }, options.map(option => /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_Checkbox__WEBPACK_IMPORTED_MODULE_1__["default"], {
    label: option.label,
...
const InfiniteScroll = _ref => {
  ...
  const [loadMoreBackwards, loadMoreForwards] = (0,_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    ...
    return [(0,_util_schedulers__WEBPACK_IMPORTED_MODULE_5__.debounce)(function () {
  ...
  (0,_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__.useLayoutEffect)(() => {
    (0,_lib_fasterdom_fasterdom__WEBPACK_IMPORTED_MODULE_2__.requestForcedReflow)(() => {
      ...
      return () => {
        (0,_util_resetScroll__WEBPACK_IMPORTED_MODULE_4__["default"])(container, newScrollTop);
...
/* harmony import */ var _MenuItem__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./MenuItem */ "./src/components/ui/MenuItem.tsx");
/* harmony import */ var _MenuSeparator__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./MenuSeparator */ "./src/components/ui/MenuSeparator.tsx");
/* harmony import */ var _RippleEffect__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./RippleEffect */ "./src/components/ui/RippleEffect.tsx");
/* harmony import */ var _ListItem_scss__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./ListItem.scss */ "./src/components/ui/ListItem.scss");
...
const ListItem = _ref => {
  ...
  const fullClassName = (0,_util_buildClassName__WEBPACK_IMPORTED_MODULE_2__["default"])('ListItem', className, allowSelection && 'allow-selection', ripple && 'has-ripple', narrow && 'narrow', disabled && 'disabled', allowDisabledClick && 'click-allowed', inactive && 'inactive', contextMenuPosition && 'has-menu-open', focus && 'focus', destructive && 'destructive', multiline && 'multiline', isStatic && 'is-static', withColorTransition && 'with-color-transition');
  ...
  return /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
  ...
  }, !disabled && !inactive && ripple && /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_RippleEffect__WEBPACK_IMPORTED_MODULE_16__["default"], null), leftElement, icon && /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_common_icons_Icon__WEBPACK_IMPORTED_MODULE_11__["default"], {
    name: icon,
  ...
  }, children), !multiline && children, secondaryIcon && /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_Button__WEBPACK_IMPORTED_MODULE_12__["default"], {
    ...
    name: secondaryIcon
  })), rightElement), contextActions && contextMenuPosition !== undefined && /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_Menu__WEBPACK_IMPORTED_MODULE_13__["default"], {
  ...
  }, contextActions.map(action => 'isSeparator' in action ? /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_MenuSeparator__WEBPACK_IMPORTED_MODULE_15__["default"], {
    key: action.key || 'separator'
  }) : /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_MenuItem__WEBPACK_IMPORTED_MODULE_14__["default"], {
    key: action.title,
    icon: action.icon,
...
const Modal = _ref => {
  ...
  } = (0,_hooks_useShowTransition__WEBPACK_IMPORTED_MODULE_11__["default"])(isOpen, onCloseAnimationEnd, shouldSkipHistoryAnimations, undefined, shouldSkipHistoryAnimations);
  // eslint-disable-next-line no-null/no-null
  ...
  (0,_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => isOpen && modalRef.current ? (0,_util_trapFocus__WEBPACK_IMPORTED_MODULE_5__["default"])(modalRef.current) : undefined, [isOpen]);
  (0,_hooks_useHistoryBack__WEBPACK_IMPORTED_MODULE_7__["default"])({
    isActive: isOpen,
    onBack: onClose
  });
  (0,_hooks_useLayoutEffectWithPrevDeps__WEBPACK_IMPORTED_MODULE_9__["default"])(_ref2 => {
    let [prevIsOpen] = _ref2;
    document.body.classList.toggle('has-open-dialog', Boolean(isOpen));
    if (isOpen || !isOpen && prevIsOpen !== undefined) {
      (0,_hooks_useHeavyAnimationCheck__WEBPACK_IMPORTED_MODULE_6__.dispatchHeavyAnimationEvent)(ANIMATION_DURATION);
    }
    return () => {
  ...
  function renderHeader() {
    ...
    }, withCloseButton && /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_Button__WEBPACK_IMPORTED_MODULE_13__["default"], {
  ...
  const fullClassName = (0,_util_buildClassName__WEBPACK_IMPORTED_MODULE_1__["default"])('Modal', className, transitionClassNames, noBackdrop && 'transparent-backdrop', isSlim && 'slim');
  return /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_Portal__WEBPACK_IMPORTED_MODULE_14__["default"], null, /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    ...
    ref: dialogRef
  }, renderHeader(), /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
...
/* harmony import */ var _Portal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Portal */ "./src/components/ui/Portal.ts");
/* harmony import */ var _Notification_scss__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Notification.scss */ "./src/components/ui/Notification.scss");
...
const Notification = _ref => {
  ...
  const closeAndDismiss = (0,_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__.useCallback)(() => {
    setIsOpen(false);
    setTimeout(onDismiss, ANIMATION_DURATION + _config__WEBPACK_IMPORTED_MODULE_2__.ANIMATION_END_DELAY);
  }, [onDismiss]);
  ...
  (0,_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => isOpen ? (0,_util_captureEscKeyListener__WEBPACK_IMPORTED_MODULE_4__["default"])(closeAndDismiss) : undefined, [isOpen, closeAndDismiss]);
  (0,_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
  ...
  const handleMouseEnter = (0,_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__.useCallback)(() => {
    if (timerRef.current) {
      clearTimeout(timerRef.current);
      timerRef.current = undefined;
    }
  }, []);
  const handleMouseLeave = (0,_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__.useCallback)(() => {
    timerRef.current = window.setTimeout(closeAndDismiss, duration);
  }, [duration, closeAndDismiss]);
  return /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_Portal__WEBPACK_IMPORTED_MODULE_7__["default"], {
    className: "Notification-container",
    containerId: containerId
  }, /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    className: (0,_util_buildClassName__WEBPACK_IMPORTED_MODULE_3__["default"])('Notification', transitionClassNames, className),
    onClick: handleClick,
  ...
  }, title), message), action && actionText && /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_Button__WEBPACK_IMPORTED_MODULE_6__["default"], {
...
function drawSpinnerArc(canvas, size, strokeWidth, color, progress, dpr) {
  let shouldInit = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : false;
  let rotationOffset = arguments.length > 7 ? arguments[7] : undefined;
...
const Radio = _ref => {
  ...
  const lang = (0,_hooks_useOldLang__WEBPACK_IMPORTED_MODULE_2__["default"])();
  const fullClassName = (0,_util_buildClassName__WEBPACK_IMPORTED_MODULE_1__["default"])('Radio', className, disabled && 'disabled', hidden && 'hidden-widget', isLoading && 'loading');
...
const RangeSlider = _ref => {
  ...
  return /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    ...
    className: "value",
    dir: "auto"
  }, renderValue ? renderValue(value) : value)), /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
...
const RangeSliderWithMarks = _ref => {
  let {
    marks,
    onChange,
    rangeCount
...
const ResponsiveHoverButton = _ref => {
  let {
    onActivate,
    ...buttonProps
  } = _ref;
...
/* harmony import */ var _Transition__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Transition */ "./src/components/ui/Transition.tsx");
/* harmony import */ var _SearchInput_scss__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./SearchInput.scss */ "./src/components/ui/SearchInput.scss");
...
const SearchInput = _ref => {
  ...
  const handleKeyDown = (0,_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__.useCallback)(e => {
    if (e.key === 'ArrowDown' || e.key === 'Enter') {
      const element = document.querySelector(`.${parentContainerClassName} .ListItem-button`);
      if (element) {
        element.focus();
      }
    }
  ...
  return /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    ...
    dir: lang.isRtl ? 'rtl' : undefined
  }, children, /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("input", {
    ref: inputRef,
    id: inputId,
    type: "text",
    dir: "auto",
    ...
    onBlur: handleBlur,
    onKeyDown: handleKeyDown
  }), /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_Transition__WEBPACK_IMPORTED_MODULE_7__["default"], {
    name: "fade",
    shouldCleanup: true,
    activeKey: Number(isLoading),
    className: "icon-container"
  }, isLoading ? /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_Loading__WEBPACK_IMPORTED_MODULE_6__["default"], {
    color: spinnerColor,
    backgroundColor: spinnerBackgroundColor,
    onClick: onSpinnerClick
  }) : /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("i", {
    className: "icon icon-search search-icon"
  })), !isLoading && (value || canClose) && onReset && /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_Button__WEBPACK_IMPORTED_MODULE_5__["default"], {
    round: true,
    size: "tiny",
    color: "translucent",
    onClick: onReset
...
const Tab = _ref => {
  ...
  return /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    ...
    className: "platform"
  })), contextActions && contextMenuPosition !== undefined && /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_Menu__WEBPACK_IMPORTED_MODULE_10__["default"], {
    isOpen: isContextMenuOpen,
    transformOriginX: transformOriginX,
    transformOriginY: transformOriginY,
    positionX: positionX,
...
const TabList = _ref => {
  ...
  // eslint-disable-next-line no-null/no-null
  const containerRef = (0,_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  const previousActiveTab = (0,_hooks_usePrevious__WEBPACK_IMPORTED_MODULE_7__["default"])(activeTab);
  ...
  return /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    className: (0,_util_buildClassName__WEBPACK_IMPORTED_MODULE_3__["default"])('TabList', 'no-scrollbar', big && 'big', className),
    ref: containerRef,
    dir: lang.isRtl ? 'rtl' : undefined
...
//# sourceMappingURL=shared-components.1b93787b37f8ea6ca70e.js.map