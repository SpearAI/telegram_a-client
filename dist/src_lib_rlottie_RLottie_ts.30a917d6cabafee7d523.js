...
const workers = (0,_util_launchMediaWorkers__WEBPACK_IMPORTED_MODULE_4__["default"])().map(_ref => {
  let {
    connector
  } = _ref;
  return connector;
...
class RLottie {
  ...
  constructor(tgsUrl, container, renderId, params) {
    let viewId = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : (0,_util_generateUniqueId__WEBPACK_IMPORTED_MODULE_3__["default"])();
...
//# sourceMappingURL=src_lib_rlottie_RLottie_ts.30a917d6cabafee7d523.js.map