...
const GroupCall = _ref => {
  ...
  const firstPresentation = (0,_lib_teact_teact__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => {
    return Object.values(participants).find(_ref2 => {
      let {
        presentation
      } = _ref2;
      return presentation;
  ...
  const videoParticipants = (0,_lib_teact_teact__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => Object.values(participants).filter(_ref3 => {
    let {
      video,
      presentation
    } = _ref3;
    ...
    return (0,_util_iteratees__WEBPACK_IMPORTED_MODULE_7__.compact)([video ? {
      id,
      type: 'video'
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_lib_teact_teact__WEBPACK_IMPORTED_MODULE_1__.memo)((0,_global__WEBPACK_IMPORTED_MODULE_2__.withGlobal)((global, _ref5) => {
  let {
    groupCallId
  } = _ref5;
  const {
...
const GroupCallParticipant = _ref => {
  let {
    participant,
    peer
  } = _ref;
  ...
  const {
    ...
    transformOriginY,
    style: menuStyle
  } = (0,_hooks_useMenuPosition__WEBPACK_IMPORTED_MODULE_9__["default"])(contextMenuPosition, getTriggerElement, getRootElement, getMenuElement, getLayout);
  ...
  return /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_ListItem__WEBPACK_IMPORTED_MODULE_13__["default"], {
    leftElement: /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_common_Avatar__WEBPACK_IMPORTED_MODULE_11__["default"], {
      peer: peer,
    ...
    ripple: true,
    ref: ref
  }, /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_common_FullNameTitle__WEBPACK_IMPORTED_MODULE_12__["default"], {
    peer: peer,
...
const GroupCallParticipantList = _ref => {
  let {
    panelOffset,
    participants,
    participantsCount,
...
const GroupCallParticipantMenu = _ref => {
  let {
    participant,
    onCloseAnimationEnd,
    onClose,
  ...
  return /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", null, /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_Menu__WEBPACK_IMPORTED_MODULE_12__["default"], {
  ...
  }, !isSelf && !shouldRaiseHand && /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    className: "group"
...
/* harmony import */ var _hooks_useMenuPosition__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../hooks/useMenuPosition */ "./src/hooks/useMenuPosition.ts");
...
/* harmony import */ var _common_FullNameTitle__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../common/FullNameTitle */ "./src/components/common/FullNameTitle.tsx");
...
const GroupCallParticipantVideo = _ref => {
  let {
    layout,
    pinnedVideo,
    setPinned,
  ...
  const {
    ...
    transformOriginY,
    style: menuStyle
  } = (0,_hooks_useMenuPosition__WEBPACK_IMPORTED_MODULE_15__["default"])(contextMenuPosition, getTriggerElement, getRootElement, getMenuElement, getLayout);
  ...
  }, /*#__PURE__*/_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_common_FullNameTitle__WEBPACK_IMPORTED_MODULE_17__["default"], {
    peer: user || chat,
...
const MicrophoneButton = _ref => {
  ...
  const isConnecting = connectionState !== 'connected';
  const shouldRaiseHand = !canSelfUnmute && isMuted;
  const prevShouldRaiseHand = (0,_hooks_usePrevious__WEBPACK_IMPORTED_MODULE_7__["default"])(shouldRaiseHand);
  (0,_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
...
const OutlinedMicrophoneIcon = _ref => {
  let {
    participant,
    noColor,
    className
  ...
  const isRaiseHand = Boolean(participant.raiseHandRating);
  const prevIsRaiseHand = (0,_hooks_usePrevious__WEBPACK_IMPORTED_MODULE_3__["default"])(isRaiseHand);
  const canSelfUnmute = Boolean(participant?.canSelfUnmute);
  const shouldRaiseHand = !canSelfUnmute && isMuted;
  const prevIsMuted = (0,_hooks_usePrevious__WEBPACK_IMPORTED_MODULE_3__["default"])(isMuted);
  const playSegment = (0,_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
...
function useGroupCallVideoLayout(_ref) {
  let {
    primaryContainerRef,
  ...
  const prevVideosCount = (0,_hooks_usePrevious__WEBPACK_IMPORTED_MODULE_2__["default"])(videosCount);
  const prevVideoParticipants = (0,_hooks_usePrevious__WEBPACK_IMPORTED_MODULE_2__["default"])(videoParticipants);
  const removedVideoParticipants = (0,_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    return prevVideoParticipants?.filter(_ref2 => {
      let {
        id,
        type
      } = _ref2;
      return !videoParticipants.some(p => p.id === id && p.type === type);
    });
  ...
  const recalculateLayout = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_1__["default"])(() => {
    ...
    if (pinnedVideo !== undefined || !primaryContainer || !isLandscapeLayout) {
      ...
      if (pinnedVideo && primaryContainer && isLandscapeLayout) {
        pinnedSkipIndex = participants.findIndex(_ref3 => {
          let {
            id,
            type
          } = _ref3;
          return id === pinnedVideo.id && type === pinnedVideo.type;
        });
        if (pinnedSkipIndex !== -1) {
          ...
          skip = true;
          participants = participants.filter(_ref4 => {
            let {
              id,
              type: videoType
            } = _ref4;
            return id !== participantId || videoType !== pinnedVideo.type;
          });
        }
      }
...
/* harmony import */ var _chats__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./chats */ "./src/global/actions/api/chats.ts");
...
(0,_index__WEBPACK_IMPORTED_MODULE_5__.addActionHandler)('leaveGroupCall', async (global, actions, payload) => {
  const {
    isFromLibrary,
    shouldDiscard,
    shouldRemove,
  ...
  global = (0,_reducers_calls__WEBPACK_IMPORTED_MODULE_7__.updateActiveGroupCall)(global, {
  ...
  await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_4__.callApi)('leaveGroupCall', {
    call: groupCall,
    isPageUnload
  });
  await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_4__.callApi)('abortRequestGroup', 'call');
  if (shouldDiscard) {
    await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_4__.callApi)('discardGroupCall', {
      call: groupCall
    });
  }
  global = (0,_index__WEBPACK_IMPORTED_MODULE_5__.getGlobal)();
  if (shouldRemove) {
    global = (0,_reducers_calls__WEBPACK_IMPORTED_MODULE_7__.removeGroupCall)(global, groupCall.id);
  }
  (0,_ui_calls__WEBPACK_IMPORTED_MODULE_11__.removeGroupCallAudioElement)();
  (0,_index__WEBPACK_IMPORTED_MODULE_5__.setGlobal)(global);
...
(0,_index__WEBPACK_IMPORTED_MODULE_5__.addActionHandler)('toggleGroupCallVideo', async global => {
  const groupCall = (0,_selectors_calls__WEBPACK_IMPORTED_MODULE_10__.selectActiveGroupCall)(global);
  const user = (0,_selectors__WEBPACK_IMPORTED_MODULE_9__.selectUser)(global, global.currentUserId);
  if (!user || !groupCall) {
    return;
  }
  await (0,_lib_secret_sauce__WEBPACK_IMPORTED_MODULE_1__.toggleStream)('video');
  await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_4__.callApi)('editGroupCallParticipant', {
    call: groupCall,
    videoStopped: !(0,_lib_secret_sauce__WEBPACK_IMPORTED_MODULE_1__.isStreamEnabled)('video'),
    participant: user
  });
});
(0,_index__WEBPACK_IMPORTED_MODULE_5__.addActionHandler)('requestToSpeak', (global, actions, payload) => {
  const {
    value
  } = payload || {
    value: true
  ...
  void (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_4__.callApi)('editGroupCallParticipant', {
    call: groupCall,
    raiseHand: value,
    participant: user
  });
});
(0,_index__WEBPACK_IMPORTED_MODULE_5__.addActionHandler)('setGroupCallParticipantVolume', (global, actions, payload) => {
  const {
    participantId,
    volume
  } = payload;
  const groupCall = (0,_selectors_calls__WEBPACK_IMPORTED_MODULE_10__.selectActiveGroupCall)(global);
  const user = (0,_selectors__WEBPACK_IMPORTED_MODULE_9__.selectUser)(global, participantId);
  if (!user || !groupCall) {
    return;
  }
...
(0,_index__WEBPACK_IMPORTED_MODULE_5__.addActionHandler)('toggleGroupCallMute', async (global, actions, payload) => {
  const {
    participantId,
    value
  } = payload || {};
  const groupCall = (0,_selectors_calls__WEBPACK_IMPORTED_MODULE_10__.selectActiveGroupCall)(global);
  const user = (0,_selectors__WEBPACK_IMPORTED_MODULE_9__.selectUser)(global, participantId || global.currentUserId);
  if (!user || !groupCall) {
    return;
  }
...
(0,_index__WEBPACK_IMPORTED_MODULE_5__.addActionHandler)('toggleGroupCallPresentation', async (global, actions, payload) => {
  const groupCall = (0,_selectors_calls__WEBPACK_IMPORTED_MODULE_10__.selectActiveGroupCall)(global);
  const user = (0,_selectors__WEBPACK_IMPORTED_MODULE_9__.selectUser)(global, global.currentUserId);
  if (!user || !groupCall) {
    return;
  ...
  if (value) {
    ...
    await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_4__.callApi)('joinGroupCallPresentation', {
      call: groupCall,
      params
    });
  } else {
    await (0,_lib_secret_sauce__WEBPACK_IMPORTED_MODULE_1__.toggleStream)('presentation', false);
    await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_4__.callApi)('leaveGroupCallPresentation', {
      call: groupCall
    });
  }
  await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_4__.callApi)('editGroupCallParticipant', {
...
(0,_index__WEBPACK_IMPORTED_MODULE_5__.addActionHandler)('connectToActiveGroupCall', async (global, actions, payload) => {
  const {
    tabId = (0,_util_establishMultitabRole__WEBPACK_IMPORTED_MODULE_2__.getCurrentTabId)()
  } = payload || {};
  const groupCall = (0,_selectors_calls__WEBPACK_IMPORTED_MODULE_10__.selectActiveGroupCall)(global);
  ...
  const audioElement = (0,_ui_calls__WEBPACK_IMPORTED_MODULE_11__.getGroupCallAudioElement)();
  const audioContext = (0,_ui_calls__WEBPACK_IMPORTED_MODULE_11__.getGroupCallAudioContext)();
  ...
  const result = await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_4__.callApi)('joinGroupCall', {
    call: groupCall,
    params,
  ...
  if (groupCall.chatId) {
    global = (0,_index__WEBPACK_IMPORTED_MODULE_5__.getGlobal)();
    const chat = (0,_selectors__WEBPACK_IMPORTED_MODULE_9__.selectChat)(global, groupCall.chatId);
    if (!chat) return;
    await (0,_chats__WEBPACK_IMPORTED_MODULE_12__.loadFullChat)(global, actions, chat, tabId);
  }
});
(0,_index__WEBPACK_IMPORTED_MODULE_5__.addActionHandler)('connectToActivePhoneCall', async (global, actions) => {
  const {
    phoneCall
  } = global;
  if (!phoneCall) return;
  ...
  if (!user) return;
  const dhConfig = await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_4__.callApi)('getDhConfig');
  if (!dhConfig) return;
  await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_4__.callApi)('createPhoneCallState', [true]);
  const gAHash = await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_4__.callApi)('requestPhoneCall', [dhConfig]);
  const result = await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_4__.callApi)('requestCall', {
    user,
    gAHash,
  ...
  global = (0,_index__WEBPACK_IMPORTED_MODULE_5__.getGlobal)();
  global = (0,_reducers__WEBPACK_IMPORTED_MODULE_6__.addUsers)(global, (0,_util_iteratees__WEBPACK_IMPORTED_MODULE_3__.buildCollectionByKey)(result.users, 'id'));
  (0,_index__WEBPACK_IMPORTED_MODULE_5__.setGlobal)(global);
});
(0,_index__WEBPACK_IMPORTED_MODULE_5__.addActionHandler)('acceptCall', async global => {
  const {
    phoneCall
  } = global;
  if (!phoneCall) return;
  const dhConfig = await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_4__.callApi)('getDhConfig');
  if (!dhConfig) return;
  await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_4__.callApi)('createPhoneCallState', [false]);
  const gB = await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_4__.callApi)('acceptPhoneCall', [dhConfig]);
  const result = await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_4__.callApi)('acceptCall', {
    call: phoneCall,
    gB
  });
  if (!result) {
...
(0,_index__WEBPACK_IMPORTED_MODULE_5__.addActionHandler)('sendSignalingData', (global, actions, payload) => {
  const {
    phoneCall
  } = global;
  if (!phoneCall) {
  ...
  (async () => {
    const encodedData = await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_4__.callApi)('encodePhoneCallData', [data]);
    if (!encodedData) return;
    (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_4__.callApi)('sendSignalingData', {
      data: encodedData,
      call: phoneCall
    });
  })();
});
(0,_index__WEBPACK_IMPORTED_MODULE_5__.addActionHandler)('closeCallRatingModal', (global, actions, payload) => {
  const {
    tabId = (0,_util_establishMultitabRole__WEBPACK_IMPORTED_MODULE_2__.getCurrentTabId)()
  } = payload || {};
...
(0,_index__WEBPACK_IMPORTED_MODULE_5__.addActionHandler)('setCallRating', (global, actions, payload) => {
  const {
    rating,
    comment,
    tabId = (0,_util_establishMultitabRole__WEBPACK_IMPORTED_MODULE_2__.getCurrentTabId)()
  ...
  const {
    ratingPhoneCall
  } = (0,_selectors__WEBPACK_IMPORTED_MODULE_9__.selectTabState)(global, tabId);
  if (!ratingPhoneCall) {
    return undefined;
  }
  (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_4__.callApi)('setCallRating', {
...
(0,_index__WEBPACK_IMPORTED_MODULE_5__.addActionHandler)('hangUp', (global, actions, payload) => {
  const {
    isPageUnload,
    tabId = (0,_util_establishMultitabRole__WEBPACK_IMPORTED_MODULE_2__.getCurrentTabId)()
  } = payload || {};
  ...
  if (phoneCall.state === 'discarded') {
    (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_4__.callApi)('destroyPhoneCallState');
  ...
  (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_4__.callApi)('destroyPhoneCallState');
  (0,_lib_secret_sauce__WEBPACK_IMPORTED_MODULE_1__.stopPhoneCall)();
  (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_4__.callApi)('discardCall', {
    call: phoneCall,
    isPageUnload
  });
...
/* harmony import */ var _reducers_calls__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../reducers/calls */ "./src/global/reducers/calls.ts");
...
/* harmony import */ var _selectors_calls__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../selectors/calls */ "./src/global/selectors/calls.ts");
    ...
    case 'updateGroupCallStreams':
      {
        ...
        if (!(0,_selectors_calls__WEBPACK_IMPORTED_MODULE_11__.selectGroupCallParticipant)(global, activeGroupCallId, update.userId)) break;
        return (0,_reducers_calls__WEBPACK_IMPORTED_MODULE_9__.updateGroupCallParticipant)(global, activeGroupCallId, update.userId, (0,_util_iteratees__WEBPACK_IMPORTED_MODULE_2__.omit)(update, ['@type', 'userId']));
      }
    case 'updateGroupCallConnectionState':
      {
        ...
        return (0,_reducers_calls__WEBPACK_IMPORTED_MODULE_9__.updateGroupCall)(global, activeGroupCallId, {
    ...
    case 'updateGroupCallConnection':
      {
        ...
        const groupCall = (0,_selectors_calls__WEBPACK_IMPORTED_MODULE_11__.selectActiveGroupCall)(global);
    ...
    case 'updatePhoneCall':
      {
        ...
        if (state === 'active' || state === 'accepted') {
          if (!verifyPhoneCallProtocol(call.protocol)) {
            const user = (0,_selectors_calls__WEBPACK_IMPORTED_MODULE_11__.selectPhoneCallUser)(global);
            if ('hangUp' in actions) actions.hangUp({
              tabId: (0,_util_establishMultitabRole__WEBPACK_IMPORTED_MODULE_1__.getCurrentTabId)()
            });
            actions.showNotification({
        ...
        if (state === 'discarded') {
          ...
          (async () => {
            ...
            (0,_index__WEBPACK_IMPORTED_MODULE_7__.setGlobal)(global);
            const result = await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_6__.callApi)('confirmCall', {
              call,
              gA,
              keyFingerprint
            });
...
function useRunThrottled(ms, noFirst) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (conference) {
  let isAnswer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  let isPresentation = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  let isP2p = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  const lines = [];
  const add = value => {
    lines.push(value);
  };
  ...
  const addSsrcEntry = entry => {
    ...
    (entry.isVideo ? videoExtensions : audioExtensions).forEach(_ref => {
      let {
        id,
        uri
      } = _ref;
...
function getUserStream(streamType) {
  let facing = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'user';
...
async function toggleStreamP2p(streamType) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (sessionDescription) {
  let isP2p = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
...
const DEFAULT_MID = 3;
let state;
async function getDevices(streamType) {
  let isInput = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
...
async function getUserStream(streamType) {
  let facing = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'user';
...
async function toggleStream(streamType) {
  let value = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
...
function initializeConnection(streams, resolve) {
  let isPresentation = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
...
function getAmplitude(array) {
  let scale = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 3;
  if (!array) return 0;
  const {
    length
  } = array;
...
//# sourceMappingURL=BundleCalls.ae7567f6fdb7b2aad267.js.map