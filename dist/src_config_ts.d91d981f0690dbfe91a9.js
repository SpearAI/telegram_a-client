"use strict";
(self["webpackChunktelegram_t"] = self["webpackChunktelegram_t"] || []).push([["src_config_ts"],{
...
/* harmony export */   COMMON_CHATS_LIMIT: () => (/* binding */ COMMON_CHATS_LIMIT),
...
/* harmony export */   DEFAULT_LANG_PACK: () => (/* binding */ DEFAULT_LANG_PACK),
...
/* harmony export */   FAST_SMOOTH_MAX_DISTANCE: () => (/* binding */ FAST_SMOOTH_MAX_DISTANCE),
/* harmony export */   FAST_SMOOTH_MAX_DURATION: () => (/* binding */ FAST_SMOOTH_MAX_DURATION),
/* harmony export */   FAST_SMOOTH_MIN_DURATION: () => (/* binding */ FAST_SMOOTH_MIN_DURATION),
/* harmony export */   FAST_SMOOTH_SHORT_TRANSITION_MAX_DISTANCE: () => (/* binding */ FAST_SMOOTH_SHORT_TRANSITION_MAX_DISTANCE),
...
/* harmony export */   MAX_SCREEN_WIDTH_FOR_EXPAND_PINNED_MESSAGES: () => (/* binding */ MAX_SCREEN_WIDTH_FOR_EXPAND_PINNED_MESSAGES),
...
/* harmony export */   PROFILE_PHOTOS_LIMIT: () => (/* binding */ PROFILE_PHOTOS_LIMIT),
...
/* harmony export */   SAFE_SCREEN_WIDTH_FOR_CHAT_INFO: () => (/* binding */ SAFE_SCREEN_WIDTH_FOR_CHAT_INFO),
/* harmony export */   SAFE_SCREEN_WIDTH_FOR_STATIC_RIGHT_COLUMN: () => (/* binding */ SAFE_SCREEN_WIDTH_FOR_STATIC_RIGHT_COLUMN),
...
/* harmony export */   SUPPORTED_IMAGE_CONTENT_TYPES: () => (/* binding */ SUPPORTED_IMAGE_CONTENT_TYPES),
...
const RELEASE_DATETIME = 1722252408310;
...
const LANG_CACHE_NAME = 'tt-lang-packs-v38';
...
const SAFE_SCREEN_WIDTH_FOR_STATIC_RIGHT_COLUMN = 1440; // px
// Screen width where Pinned Message / Audio Player in the Middle Header shouldn't collapse with ChatInfo
const SAFE_SCREEN_WIDTH_FOR_CHAT_INFO = 1150; // px

const MIN_SCREEN_WIDTH_FOR_STATIC_RIGHT_COLUMN = 1275; // px
const MIN_SCREEN_WIDTH_FOR_STATIC_LEFT_COLUMN = 925; // px
const MAX_SCREEN_WIDTH_FOR_EXPAND_PINNED_MESSAGES = 1340; // px
...
const FAST_SMOOTH_MAX_DISTANCE = 750;
const FAST_SMOOTH_SHORT_TRANSITION_MAX_DISTANCE = 300; // px

// Average duration of message sending animation
const API_UPDATE_THROTTLE = Math.round((FAST_SMOOTH_MIN_DURATION + FAST_SMOOTH_MAX_DURATION) / 2);
const API_THROTTLE_RESET_UPDATES = new Set(['newMessage', 'newScheduledMessage', 'deleteMessages', 'deleteScheduledMessages', 'deleteHistory', 'updateThreadInfos']);
...
const SUPPORTED_IMAGE_CONTENT_TYPES = new Set(['image/png', 'image/jpeg', GIF_MIME_TYPE]);
...
const CONTENT_TYPES_WITH_PREVIEW = new Set([...SUPPORTED_IMAGE_CONTENT_TYPES, ...SUPPORTED_VIDEO_CONTENT_TYPES]);
...
const DEFAULT_LANG_PACK = 'android';
...
//# sourceMappingURL=src_config_ts.d91d981f0690dbfe91a9.js.map