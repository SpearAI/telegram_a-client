...
function getLanguageName(alias) {
  return Object.entries(SUPPORTED_LANGUAGES).find(_ref => {
    let [langName, aliases] = _ref;
    return langName === alias || aliases.includes(alias);
  })?.[0];
}
...
//# sourceMappingURL=src_util_highlightCode_ts.80966163e001cbcc4006.js.map